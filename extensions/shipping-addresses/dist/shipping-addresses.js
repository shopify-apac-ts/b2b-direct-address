(() => {
  ...
  // extensions/shipping-addresses/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    var _a, _b;
    const [selectedAddress, setSelectedAddress] = (0, import_react16.useState)("Address 1");
    ...
    const address_str = shipping && shipping.length > 0 ? (_b = (_a = shipping[0]) == null ? void 0 : _a.metafield) == null ? void 0 : _b.value : "{}";
    ...
    function updateAddress() {
      return __async(this, null, function* () {
        ...
        const result = yield applyShippingAddressChange({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { children: [
      i == 3 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Banner2,
        {
          status: "info",
      ...
      i == 3 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        ChoiceList2,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Choice2, { id: "Address 1", children: [
              address_json["Address 1"].address1,
              ", ",
              address_json["Address 1"].city,
              ", ",
              address_json["Address 1"].provinceCode,
              ", ",
              address_json["Address 1"].postalCode
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Choice2, { id: "Address 2", children: [
              address_json["Address 2"].address1,
              ", ",
              address_json["Address 2"].city,
              ", ",
              address_json["Address 2"].provinceCode,
              ", ",
              address_json["Address 2"].postalCode
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Choice2, { id: "Address 3", children: [
              address_json["Address 3"].address1,
              ", ",
              address_json["Address 3"].city,
              ", ",
              address_json["Address 3"].provinceCode,
              ", ",
              address_json["Address 3"].postalCode
            ] })
          ] })
        }
      )
